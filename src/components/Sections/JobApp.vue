<template>
  <div id="job" class="jobApp bg-[#A9C338]">
    <div class="w-full flex justify-end">
      <img src="@/assets/bant2.webp" class="right w-[15%]" loading="lazy" decoding="async" />
    </div>
    <div class="relative">
      <div
        class="absolute flex flex-col items-center justify-center -rotate-6 uppercase italic pl-[4%] -mt-[8%]"
      >
        <img src="@/assets/icon1.webp" class="absolute left-[80%] w-[40%]" loading="lazy" decoding="async" />
        <div
