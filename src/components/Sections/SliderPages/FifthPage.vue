<template>
  <div class="bg-[#D4E2D5] flex w-full swipperSliderHeight items-center justify-center gap pt-10">
    <img
      ...
      alt="fevkinde_ajans"
      class="absolute top-[20%] right-0 !h-[30%] sm:!h-[30%] md:!h-[20%] lg:!h-[30%] xl:!h-[30%] 2xl:!h-[30%] w-auto mask2 opacity-30"
    />

    <img
      src="@/assets/kare.webp"
      alt="fevkinde_ajans"
      class="absolute bottom-0 left-0 !h-[25%] sm:!h-[20%] md:!h-[20%] lg:!h-[30%] xl:!h-[30%] 2xl:!h-[30%] w-auto opacity-30 mask1"
    />
    <img
      src="@/assets/kare.webp"
      alt="fevkinde_ajans"
    ...
    >
      ...
      <div
        class="light-font italic text-black text-xs sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-light pt-[3%] !text-center w-full"
      >
        Burada kötü sürprizlere yer yok!
      </div>
    </div>
  </div>
</template>
